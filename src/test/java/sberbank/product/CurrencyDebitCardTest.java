...
public class CurrencyDebitCardTest {
    ...
    @BeforeEach
    void setUp() {
        currencyDebitCard = new CurrencyDebitCard(TestConstants.CURRENCY_DEBIT_CARD_NAME, TestConstants.CURRENCY_USD, 1000);
    }
    ...
    void withdrawDecreasesBalance() {
        currencyDebitCard.withdraw(400);
        assertEquals(600, currencyDebitCard.getBalance());
    }

    @Test
    @DisplayName("Снятие положительной суммы денег, которая превышает текущий баланс")
    void withdrawThrowsIfInsufficientFunds() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> currencyDebitCard.withdraw(1500));
    ...
    void withdrawThrowsIfNegative() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> currencyDebitCard.withdraw(-500));
    ...
    void depositIncreasesBalance() {
        ...
        assertEquals(1500, currencyDebitCard.getBalance());
    }

    @Test
    @DisplayName("Пополнение отрицательной суммы денег")
    void depositThrowsIfNegative() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> currencyDebitCard.deposit(-100));
        assertEquals(ErrorMessages.NEGATIVE_AMOUNT, e.getMessage());
    }
    ...
    void shouldThrowExceptionWhenCreatingCardWithNegativeInitialBalance() {
        Exception e = assertThrows(IllegalArgumentException.class,
                () -> new CurrencyDebitCard(TestConstants.DEBIT_CARD_NAME,
